...
(function(){
  ...
  document.title=t.name+' — аренда в Шымкенте · QURAL-SAIMAN';
  (function(){
    var cn=QS.catById(t.cat)||{};
    var desc=t.name+(t.brand?' ('+t.brand+')':'')+' в аренду в Шымкенте'+
    ...
    set('meta[property="og:title"]','content',t.name+' — QURAL-SAIMAN');
    set('meta[property="og:description"]','content',desc);
    set('meta[property="og:url"]','content',url);
    if(t.photo) set('meta[property="og:image"]','content',img);
    var s=document.createElement('script');
    s.type='application/ld+json';
    s.textContent=JSON.stringify({'@context':'https://schema.org','@type':'Product',name:t.name,brand:t.brand||undefined,
      category:cn.name||undefined,description:t.spec||desc,image:t.photo?img:undefined,
      offers:{'@type':'Offer',priceCurrency:'KZT',price:t.price||undefined,
        url:url,seller:{'@type':'Organization',name:'QURAL-SAIMAN'}}});
