...
(function(){
  ...
  var read=function(){
    ...
    var st={ items:[], from:todayIso(), days:3 };
  ...
  var clear=function(){ return write({items:[],from:todayIso(),days:3}) };
  ...
  var totals=function(){
    ...
    return { gross:gross, net:net, gift:gross-net, onRequest:onRequest, days:st.days, from:st.from };
  };
  ...
  window.QSCart={ read:read, add:add, addConfig:addConfig, setQty:setQty, remove:remove, setDays:setDays, setFrom:setFrom,
